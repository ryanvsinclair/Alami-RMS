    ...
    >
      ...
      {collapsed ? (
        <button
          type="button"
          onClick={onToggle}
          className="block w-full rounded-xl bg-foreground/[0.05] px-4 py-3 text-left transition-colors hover:bg-foreground/[0.08]"
        >
          {loading ? (
        ...
        <>
          ...
          {!loading && !error && transactions.length === 0 && (
            <div className="py-12 text-center">
              <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-xl bg-foreground/4">
