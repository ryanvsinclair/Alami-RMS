    ...
    <>
      ...
      <div className="space-y-4 p-4 pb-28">
        ...
        <Card>
          ...
          <div className="space-y-2">
            {members.map((member) => (
              <div key={member.user_id} className="flex items-center justify-between rounded-2xl border border-border/80 bg-white/5 p-3">
                <div>
                ...
                <Badge variant={member.role === "owner" ? "success" : member.role === "manager" ? "warning" : "default"}>
                  {member.role}
                </Badge>
              </div>
            ))}
