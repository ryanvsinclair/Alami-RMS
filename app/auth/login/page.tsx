  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <h1 className="mt-1 text-3xl font-bold text-foreground"></h1>
      </div>

      <form action={signInAction} className="space-y-3 rounded-3xl border border-[rgba(128,164,202,0.24)] bg-[linear-gradient(150deg,rgba(20,42,67,0.72)_0%,rgba(14,30,50,0.7)_60%,rgba(10,22,39,0.8)_100%)] p-5">
